...
<body>
    ...
    <header class="header"><p>Welcome to Hospital Management System | Consultant Details </p></header>
    <form method="post" action="ViewConsultant.php">
        
        <div class="main-top" >
        <div>
        <?php
            
                $sql4 = "SELECT * FROM consultant";
