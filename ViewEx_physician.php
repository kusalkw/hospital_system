...
<body>
    ...
    <header class="header"><p>Welcome to Hospital Management System | Ex_physiciant Details </p></header>
    <form method="post" action="ViewEx_physician.php">
        
        <div class="main-top" >
        <div>
        <?php
            
                $sql4 = "SELECT * FROM ex_physician";
