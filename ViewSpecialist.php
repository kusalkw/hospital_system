...
<body>
    ...
    <header class="header"><p>Welcome to Hospital Management System | Specialist Details </p></header>
    <form method="post" action="ViewSpecialist.php">
        
        <div class="main-top" >
        <div>
        <?php
            
                $sql4 = "SELECT * FROM specialist s ,";
